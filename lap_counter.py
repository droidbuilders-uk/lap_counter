...
def main():
    ...
    while True:
                ...
                if not is_cooling_down:
                    if marker_id in previous_positions:
                        ...
                        if crossed_down or crossed_up:
                            ...
                            print(f"[{time.strftime('%H:%M:%S')}] Droid #{marker_id} crossed the line! "
                                  f"Lap: {lap_counts[marker_id]}")
        ...
        cv2.putText(frame, f"Res: {width}x{height}", (10, 70), cv2.FONT_HERSHEY_SIMPLEX, 1,
